...
public class LaporTask extends AsyncTask<String,Void,String> {
   private  Context ctx;
    private String username,password;
   private  AlertDialog alertDialog;
    LaporTask(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        String login_url = "https://toelve.com/linmasbjm/mobile/enterdata";
          ...
          String  longi=params[2];
            ...
            try {
                ...
                String data = URLEncoder.encode("lat", "UTF-8") + "=" + URLEncoder.encode(lat, "UTF-8") + "&" +
                        ...
                        URLEncoder.encode("perihal", "UTF-8") + "=" + URLEncoder.encode(perihal, "UTF-8") + "&" +
