...
public class LaporanKecelakaan extends AppCompatActivity implements
        GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    private Snackbar snackbar = null;
    private GoogleApiClient mGoogleApiClient;
    private SharedPreferences loginPreferences;
    private Button btSave;
    private int CAM_REQUEST1 = 1,spgcount;
    private int CAM_REQUEST3 = 3;
    private int CAM_REQUEST2 = 2;
    private AlertDialog alert = null;
    private String lat,longi,foto,jam,tanggal,username,laporan,alamat;
    private TextView tvTgl,tvJam,tvNamaPelapor;
    private AlertDialog.Builder alertDialogBuilder = null;
    private ImageView ivAmbilGambar;
    private EditText etLaporan,etAlamat;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laporan_kecelakaan);
        ...
        ivAmbilGambar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(LaporanKecelakaan.this);
                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (items[item].equals("Take Photo")) {
                            ...
                            intent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(LaporanKecelakaan.this, LaporanKecelakaan.this.getApplicationContext().getPackageName() + ".chiplinmas.fileprovider", file));
        ...
        btSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(alamat.equalsIgnoreCase("")|| etLaporan.getText().toString().equals("")||foto==null||foto.equalsIgnoreCase("")){
                    Toast.makeText(LaporanKecelakaan.this,"Semua Harus Diisi Dengan Benar",Toast.LENGTH_SHORT).show();
                }else {
                    if(isNetworkAvailable()) {

                        new LaporKecelakaanTask(LaporanKecelakaan.this).execute("Lapor", lat, longi, foto,username,tanggal, jam,laporan,alamat);
                    }else
                    {
                        ...
                        snackbar.setAction("Refresh", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                snackbar.dismiss();
                                startActivity(new Intent(LaporanKecelakaan.this, Laporan.class));
                                finish();
                            }
                        });
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if(mLastLocation !=null) {
            ...
            Geocoder geocoder = new Geocoder(LaporanKecelakaan.this, Locale.getDefault());
            String alamat;
            try {
    ...
    public void onBackPressed() {
        alertDialogBuilder = new AlertDialog.Builder(LaporanKecelakaan.this);
        alertDialogBuilder.setMessage("Batalkan Pelaporan?")
                ...
                .setPositiveButton("Batalkan",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                dialog.cancel();
                                startActivity(new Intent(LaporanKecelakaan.this,Home.class));
                                finish();
                            }
                        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAM_REQUEST1 && resultCode == Activity.RESULT_OK) {
            File file = new File( getExternalFilesDir(Environment.DIRECTORY_PICTURES),  "foto1.jpg");
            Bitmap bitmap = decodeSampledBitmapFromFile(file.getAbsolutePath(), 1024, 768);
            Bitmap realimage = rotate(bitmap, 90);
